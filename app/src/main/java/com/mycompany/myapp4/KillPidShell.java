...
//目的是为了杀死进程
public class KillPidShell {

    private Process process;//shell进程
    private KillPidShell.Callback callback;//回调接口
    ...
    public KillPidShell() throws Throwable {
    ...
    //设置监听回调
    public void setCallback(KillPidShell.Callback callback) {
